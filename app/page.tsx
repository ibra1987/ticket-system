...
export default function Home() {
  return (
    <main className="w-full flex min-h-screen flex-col items-center justify-between ">
      ...
      <section className="w-full p-4 pb-20  flex flex-col justify-center items-center bg-blue-500 ">
        <h2 className="w-full text-5xl text-center font-extrabold p-10 mb-6 text-white  ">
      ...
      <section className="w-full flex flex-col justify-start items-center  bg-gradient-to-l from-white via-pink-100 to white p-10">
        <h2 className="w-full text-5xl text-center font-extrabold p-10 mb-6 text-gray-800">
          Testimonials
        </h2>
        <Testimonials />
